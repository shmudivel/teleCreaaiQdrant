...
5. **Video Generation** - Creates videos using the HeyGen API with an AI avatar
6. **Publishing** - Uploads videos to Google Drive and/or YouTube
...
- `api_utils.py` - Utilities for API resilience, retry logic, and rate limiting
