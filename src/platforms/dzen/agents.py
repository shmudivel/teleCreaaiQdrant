...
class DzenAgents:
    ...
    TARGET_AUDIENCE = dedent("""\
        ...
        Пример: Наташа - старательный сотрудник, который годами не может вырасти 
        из-за незнания корпоративных механизмов продвижения. ТЕЗИС - не уходите в свой бизнес, продолжайте работать в найме""")
