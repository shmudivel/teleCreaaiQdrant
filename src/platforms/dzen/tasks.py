        ...
        return Task(
            ...
            expected_output=dedent(f"""\
                ...
                - Обязательные элементы:
                  * Заголовок в Дзене – 50% успеха -- так что делаем клик бейт
                  * Цепляющий H1 заголовок (6-8 слов) 
                  * Первые 3 предложения: провокационный вопрос/утверждение + проблема аудитории
                - Формат:
                  * СОБЛЮДАТЬ тон и характер 
                  * СОБЛЮДАТЬ ПРИЧИННО-СЛЕДСТВЕННУЮ СВЯЗЬ 
                  ...
                  * не придумывать истории и факты, использовать те которые есть "Опыт и истории", и что есть в векторной базе знаний tools
                  * если есть факты и цифры, то использовать их"""),
            agent=agent
        )
    ...
    def content_creation_task_part2(self, agent, structure_part):
        return Task(
            ...
            expected_output=dedent(f"""\
                ...
                - Учитывать что написанно в прошлой части, чтобы был плавный переход
                - Формат:
                  * СОБЛЮДАТЬ тон и характер 
                  * СОБЛЮДАТЬ ПРИЧИННО-СЛЕДСТВЕННУЮ СВЯЗЬ 
